			...
			<div class="row" style="padding:30px;">
				...
				<div class="col-lg-8">
					<form:form role="form" modelAttribute="order" method="post"
						...
						<div class="form-group">
							<label>Số lượng</label> <input class="form-control" type="number" required="required"
								name="productQuantity" value="${productQuantity}">
						...
						<div class="form-group">
							<label>Họ tên </label>
							<form:input cssClass="form-control" path="customerName" required="required"/> 
						</div>
						<div class="form-group">
							<label>Email </label>
							<form:input cssClass="form-control" path="email" required="required" />
